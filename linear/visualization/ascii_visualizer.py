...
class AsciiVisualizer:
    ...
    def singly(
        ...
        Args:
            head: Head node (must have .data and .next attributes).
            node_repr: Callable that converts a node's data to a string.
        ...
        while current is not None:
            ...
            if node_id in visited:
                ...
                break
            visited.add(node_id)
            parts.append(node_repr(current.data))
    ...
    def doubly(
        ...
        Args:
            head: Head node (must have .data, .next, .prev attributes).
            tail: Tail node.
            node_repr: Callable that converts a node's data to a string.
