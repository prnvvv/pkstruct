...
class LinkedListVisualizer:
    ...
    def debug_view(self, list_instance: Any) -> dict[str, Any]:
        ...
        head_value = list_instance.head.data if list_instance.head is not None else None

        # Tail: DoublyLinkedList has .tail; others we derive
        if isinstance(list_instance, DoublyLinkedList):
            tail_value = list_instance.tail.data if list_instance.tail is not None else None
